...
def calc_accuracy_seq(bin_id_to_genome_id_to_total_length, gold_standard):
    ...
    # summing up assigned and unassigned seq is equivalent to summing up the nb seq of all genomes
    denominator_p = 0
    for genome_id in gold_standard.genome_id_to_total_nb.keys():
        denominator_p += gold_standard.genome_id_to_total_nb[genome_id]
...
def compute_metrics_seq(query, gold_standard):
    """
    @param query
    @param gold_standard
    ...
    accuracy = calc_accuracy_seq(bin_id_to_genome_id_to_total_length, gold_standard)
    return accuracy
